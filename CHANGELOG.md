...
- Отдельная генерация по образцу без сохранения истории: новый экран с автоподстановкой промпта, обязательными фото (каждое фото генерируется отдельно) и прямым запуском генерации.
